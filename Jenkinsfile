            ...
            container("maven"){
              ...
              configFileProvider([configFile(fileId: 'maven-nexus-settings', variable: 'MAVEN_SETTINGS_XML')]) {
                sh """
                  ...
                  mvn -s \$MAVEN_SETTINGS_XML source:jar deploy source:test-jar -Pdistro-ce,distro-wildfly,distro-webjar -B
                """
                stash name: "artifactStash", includes: ".m2/org/camunda/**/*-SNAPSHOT/**,.m2/org/camunda/bpm/license-book-**.zip", excludes: "**/*.zip,**/*.tar.gz"
              }
            }
          }
        }
