...
String getPostgresAgent(Integer mavenCpuLimit = 3, String dockerTag = '9.6.18'){
  // assuming one core left for main maven thread
  String mavenForkCount = mavenCpuLimit - 1;
  // assuming 2Gig for each core
  String mavenMemoryLimit = mavenCpuLimit * 2;
...
String getMariaDbAgent(Integer mavenCpuLimit = 3, String dockerTag = '10.2'){
  // assuming one core left for main maven thread
  String mavenForkCount = mavenCpuLimit - 1;
  // assuming 2Gig for each core
  String mavenMemoryLimit = mavenCpuLimit * 2;
...
String getMySqlAgent(Integer mavenCpuLimit = 3, String dockerTag = '5.7.31'){
  // assuming one core left for main maven thread
  String mavenForkCount = mavenCpuLimit - 1;
  // assuming 2Gig for each core
  String mavenMemoryLimit = mavenCpuLimit * 2;
